...
- 晚上19：30，参加组内第一次线下全体会议，主要确定分工问题，并明确了项目的第一个里程碑；本人在现阶段主要负责阅读工业品缺陷检测相关论文，结合论文内容为算法优化提出针对性的意见。
...
- 本阶段阅读前沿论文为算法优化提供方法的任务已经大致完成，我们的项目进入了下一个阶段，我也被重新分到了项目管理和系统设计小组。
...
- 我今天主要的工作是需要绘制了一个上传图片的流程图，以直观明了地介绍我们的核心功能——上传图片以进行工业品检测。
