...
(function () {
  ...
  var option = {
    ...
    series: [{
      ...
      barWidth: '35%',
      // ajax传动态数据
      data: [0.9, 0.8, 0.9, 0.7, 1.0, 0.85, 0.95],
      itemStyle: {
        // 修改柱子圆角
        barBorderRadius: 5
      }
...
(function () {
  ...
  var option = {
    ...
    yAxis: [{
      ...
      data: ["VGG", "其他模型1", "其他模型2", "其他模型3", "xxxx"]
    }, {
      // y轴数据反转，与数组的顺序一致
      inverse: true,
      show: true,
...
(function () {
  ...
  var yearData = [{
      ...
      data: [
        // 两个数组是因为有两条线
        [0.9, 0.5, 0.8, 0.75, 0.69, 0.48, 0.85, 0.66, 0.85, 0.93, 0.98, 0.99],
        [0.88, 0.66, 0.77, 0.5, 0.98, 0.96, 0.77, 0.66, 0.8, 0.9, 0.7, 0.5]
      ]
    },
    {
      year: "2021", // 年份
